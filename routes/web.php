...
use App\Http\Controllers\ProfileController; // <--- Import Controller Profile
...
Route::middleware(['auth'])->group(function () {
    ...
    // 4. GROUP: JADWAL (Generate & Export)
    ...
    // 6. GROUP: PROFILE (BARU - Edit Profil User Login)
