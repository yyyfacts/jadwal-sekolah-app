        ...
        <div class="overflow-auto max-h-[75vh] custom-scrollbar relative bg-white">
            <table class="w-full text-left border-collapse min-w-[900px]">
                ...
                <thead
                    ...
                    <tr>
                        <th class="px-4 py-3 w-14 text-center border-b border-slate-200 bg-slate-50">#</th>
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <span class="text-sm font-medium text-slate-500">Belum ada user tambahan.</span>
                            </div>
                        </td>
                    </tr>
                    @endforelse
