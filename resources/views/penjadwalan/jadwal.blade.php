    ...
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 h-[calc(100vh-7rem)] pb-4 pt-2 flex flex-col">
        ...
        <div
            ...
            <div class="p-6 border-b border-slate-100 bg-white/50 shrink-0 z-20">
                ...
                {{-- Bottom Header: Searchable Filters (CSS HARCODE RESET) --}}
                <div class="mt-5 pt-5 border-t border-slate-100/60 w-full max-w-4xl">
                    <form action="{{ route('jadwal.index') }}" method="GET"
                        class="flex flex-col sm:flex-row gap-4 items-end">

                        {{-- Bungkus div pakai style spesifik untuk membunuh class bawaan tailwind-forms --}}
                    ...
                    <table class="w-full text-xs border-separate border-spacing-0 min-w-[800px]">
                        ...
                        <tbody class="bg-white">
                            ...
                            @foreach($hariList as $hari)
                                ...
                                @for($jam = $startJam; $jam <= $maxJam; $jam++)
                                ...
                                <tr>
                                    <td colspan="{{ $kelass->count() + 3 }}" class="bg-slate-200/50 h-1 border-b border-slate-200">
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
...
@push('styles')
    ...
    <style>
        ...
        /* =========================================================
       PERBAIKAN FINAL TOM SELECT (MEMBUNUH TAILWIND FORMS)
       ========================================================= */

        /* Bungkus pemaksaan CSS untuk input */
        ...
        /* Mematikan paksaan padding & display block dari form.css bawaan Laravel */
        .tom-select-container .ts-control input[type="text"] {
        ...
        /* Menyembunyikan text asli pas lagi mau ngetik */
        .tom-select-container .ts-control.has-items.focus .item {
