        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar bg-white">
            <table class="w-full text-left border-collapse min-w-[600px]">
                <thead class="bg-slate-50 sticky top-0 shadow-sm z-10">
                    <tr>
                        <th
                            class="px-4 py-2 text-[10px] font-bold text-slate-500 uppercase tracking-wider w-[25%] border-b border-slate-200">
                            Nama Hari</th>
                        <th
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="px-4 py-12 text-center text-[11px] text-slate-400">Belum ada data hari.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
