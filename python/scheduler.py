...
# TIPS: Naikkan menjadi 120 atau 180 jika ingin SCFR yang lebih maksimal
MAX_WAKTU_SOLVER = 60
...
def main():
    ...
    # --- PERUBAHAN: Bagian AddDecisionStrategy dihapus/dikomen ---
    # if all_start_vars:
    ...
    # --- PERUBAHAN: Parameter LNS ditekankan ---
